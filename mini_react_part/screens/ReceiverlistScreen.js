...
const ReceiverlistScreen = () => {
    ...
    const fetchReceivers = async () => {
        try {
            const apiresponse = await axios.get('http://192.168.1.4:8080/api/v1/admin/fetchallReceivers');
    ...
    const deleteReceiver = async (username) => {
        try {
            ...
            await axios.delete(`http://192.168.1.4:8080/api/v1/admin/deleteUserByUsername?username=${username}`);

...
const PostDetailviewdonor = ({route}) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                apiresp = await axios.get("http://192.168.1.4:8080/api/v1/commitment/count", {
                    headers: {
    ...
    const deleteUserPost = async(postid) => {
        try{
            apiresponse =  await axios.delete("http://192.168.1.4:8080/api/v1/postdesc/delete", {
               headers:{
                "Content-Type":'application/json'
              },
              params:{
    ...
    const handlePress = async () => {
        try {
            ...
            const receiver = route.params.receiver;
                ...
                const resp = await axios.get("http://192.168.1.4:8080/api/v1/auth/fetchUser", {
                    headers: {
                        "Content-Type": 'application/json'
                    },
                    params:{
            ...
            const createResponse = await axios.post("http://192.168.1.4:8080/api/v1/commitment/create", payload, {
                headers: {
                    "Content-Type": "application/json"
                }
            });
    ...
    //         apiresponse =  await axios.post("http://192.168.1.4:8080/api/v1/commitment/create", payload,{
    //         headers:{
    //           "Content-Type":'application/json'
    //     }
    //   })
